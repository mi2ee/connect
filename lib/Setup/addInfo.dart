          ...
          SingleChildScrollView(
            child: Column(
              ...
              Row(
                ...
                ResponsiveContainer(widthPercent: 25.0, heightPercent: 20.0,
                ...
                ResponsiveContainer(widthPercent: 55.0, heightPercent: 24,
                  child: Container(
                    child: Container(
                      child: Form(
                          key: _formKey,
                                ...
                                decoration: InputDecoration(
                                  ...
                                  validator: (str) {
                                    if (str.length > 1) {
                                      ...
                                      return ('Dude your Last Name!'); //Haha love that
                                    }
                                  },
                ...
                child: Form(
                    ...
                    child: Column(
                      children: <Widget>[
                          ...
                          decoration: InputDecoration(
                            ...
                            validator: (str) {
                              if (str.length > 1) {
                                ...
                                return ("You don't have any Friends?"); ///////Ohhh shit
                              }
                            },
                        ...
                        TextFormField(
                          decoration: InputDecoration(
                              labelText: 'one sentence that describes you best',
                              labelStyle: TextStyle(
                        ...
                        TextFormField(
                          decoration: InputDecoration(
                              labelText: 'Your title //choose from list',
                              labelStyle: TextStyle(
